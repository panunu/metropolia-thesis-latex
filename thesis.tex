...
% All general information (title, author (you), degree programme, major option, etc.)
...
\def\thesis{Insinöörityö/Thesis} %Opinnäytetyö
...
% style/style.tex file (or install LiberationSans font to your system).
% If you are using MacOS or linux, make sure you have LiberationSans font installed.
