...
\usepackage{datetime}
\usepackage{hyperref} % for automagic pdf links for toc, refs, etc.
...
\setmainfont{LiberationSans-Regular.ttf} %replace with arial.ttf if you have the fontfile
%line space
\linespread{1.5}
%\doublespacing
%margin
...
%
\vspace*{9.5cm}
\tn{\LARGE \@author\\[0.75cm]\Huge \IfLanguageName {finnish}{\otsikko}{\@title}}\\[3.5cm]
...
\newif\iftiivistelma
\IfLanguageName{finnish}{\tiivistelmatrue}{\tiivistelmafalse}
...
\node (yksi) [palikka] {Lorem};
\node (kaksi) [palikka, right of=yksi] {ipsum};
\node (kolme) [palikka, below of=kaksi] {dolor};
\node (neljä) [palikka, left of=kolme] {sit};
\node (viisi) [palikka, below of=neljä] {amet};
\draw [arrow] (yksi) -- (kaksi);
\draw [arrow] (kaksi) -- (kolme);
...
\makeevenhead{plain}{}{}{\appname \thechapter \\ \thepage (\stepcounter{appx1}\total{appx1})}
\makeoddhead{plain}{}{}{\appname \thechapter \\ \thepage (\stepcounter{appx1}\total{appx1})}
...
%overwrite the header
\makeevenhead{plain}{}{}{\appname \thechapter \\ \thepage (\stepcounter{appx2}\total{appx2})}
\makeoddhead{plain}{}{}{\appname \thechapter \\ \thepage (\stepcounter{appx2}\total{appx2})}
