...
%TODO: video, conversation/interview
% set right format
...
\DeclareFieldFormat[online]{url}{\space\IfLanguageName{finnish}{Verkkoaineisto.}{Online.}\space\textless\url{#1}\textgreater .} % you can modify how to url looks here
